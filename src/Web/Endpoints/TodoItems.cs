...
using clean3.Application.TodoItems.Commands.UpdateTodoItem;
using clean3.Application.TodoItems.Commands.UpdateTodoItemDetail;
using clean3.Application.TodoItems.Queries.GetTodoItemsWithPagination;

namespace clean3.Web.Endpoints;
